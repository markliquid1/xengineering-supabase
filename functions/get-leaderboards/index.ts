// supabase/functions/get-leaderboards/index.ts    TESTFORCHANGE
...
Deno.serve(async (req)=>{
  ...
  try {
    ...
    if (type === 'energy') {
      ...
      let query = supabase.from('user_profiles').select('device_uid, username, boat_type, boat_length_ft').eq('profile_public', true);
